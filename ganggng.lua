    ...
    local function MainEventLocate()
     ...
     -- // Libraries
     local NotificationHolder = loadstring(game:HttpGet("https://raw.githubusercontent.com/mur1/bookish-octo-rotary-phone/main/module.lua"))()
     local Notification = loadstring(game:HttpGet("https://raw.githubusercontent.com/mur1/bookish-octo-rotary-phone/main/blablabla"))()
     local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/mur1/bookish-octo-rotary-phone/main/ganggang"))()
     ...
     local function SendNotification(text)
        Notification:Notify(
            {Title = "muriware - #1", Description = " "..text},
     ...
     if uwuMain.Notifications then
        SendNotification("@mu.rii - injecting muriware")
        wait(3.5)
        SendNotification("@mu.rii - finished injecting muriware")
        wait(3.5)
        SendNotification("@mu.rii - Start 2 tapping Son")
     end
    ...
    if uwuCUMCUMCUM == true then
        local words = {
            'come tapn with muriware',
            'quit missing ur shots and tapn with muriware',
            'why miss when u can buy muriware😂',
            'start hitting ur shots wit muriware',
